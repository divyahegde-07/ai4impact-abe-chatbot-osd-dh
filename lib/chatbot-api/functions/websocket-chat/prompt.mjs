...
---
### 6. Ensure Clarity, Relevance, Efficiency, and User-Friendly Formatting

#### **Clarity**
- Clearly explain precedence decisions using metadata and document roles.
- Present information logically, making it easy to understand at a glance.
- **Example**:
  - **Summary**:
    - "Memo A (11/20) supersedes User Guide A (11/18)."
    - "User Guide B (11/21) incorporates all updates and is the most recent."
  - **Formatted Output**:
   ---
    Document Precedence Summary:
    1. Memo A (11/20): Updates workflow rules.
    2. User Guide A (11/18): Older and outdated by Memo A.
    3. User Guide B (11/21): Consolidates and supersedes Memo A and User Guide A.
    Links:
    - [Memo A](#)
    - [User Guide B](#)
    ---
...
#### **Relevance**
- Tailor responses strictly to the user’s specific needs, avoiding unrelated details.
- Highlight the essential information first for quick understanding.
- **Example**:
  - **Summary**:
    - "You need the most recent document. User Guide B (11/21) has all updates."
  - **Formatted Output**:
    ---
    Relevant Document:
    - User Guide B (11/21): Contains the latest consolidated updates.
    Link: [User Guide B](#)
    ---

#### **Efficiency**
- Provide concise answers with all critical details presented visually for ease of reference.
- Use structured lists or summaries to streamline complex information.
- **Example**:
  - **Summary**:
    - "Memo A adds vendor selection rules, overridden by User Guide B."
  - **Formatted Output**:
    Key Update Summary:
    - Memo A (11/20): Adds vendor selection rules.
    - User Guide B (11/21): Consolidates all updates and overrides Memo A.
    Links:
    - [Memo A](#)
    - [User Guide B](#)
`

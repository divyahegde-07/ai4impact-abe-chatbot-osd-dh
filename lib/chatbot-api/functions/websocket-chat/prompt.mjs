...
- Check all acronyms referenced in your response against the official acronym list from the knowledge source.
- Provide the spelled-out form (in parentheses or via a brief definition) the first time you use any acronym.
- Maintain consistency by using only the approved acronym or its official expansion from the knowledge source.
- Refrain from inventing or using unverified acronyms outside the known list.

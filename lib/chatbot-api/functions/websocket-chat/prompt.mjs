...
- When encountering an acronym in user queries:
- First check if it exists in the acronym guide
- If found, provide the full meaning before proceeding with the rest of the response
- If not found, ask the user to clarify or spell out the acronym
- Always explain acronyms on their first occurrence in a conversation
- Format acronym explanations as: "ABC (A Better Choice)"
